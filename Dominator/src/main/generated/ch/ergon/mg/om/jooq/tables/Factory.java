...
import ch.ergon.mg.om.jooq.tables.records.FactoryRecord;
...
public class Factory extends TableImpl<FactoryRecord> {
     ...
     */
    public final TableField<FactoryRecord, FactoryType> FACTORY_TYPE = createField("factory_type", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(ch.ergon.mg.om.jooq.enums.FactoryType.class), this, "");

    /**
     * The column <code>sab.factory.parameter_type</code>.
     */
    public final TableField<FactoryRecord, FactoryParameterType> PARAMETER_TYPE = createField("parameter_type", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(ch.ergon.mg.om.jooq.enums.FactoryParameterType.class), this, "");
