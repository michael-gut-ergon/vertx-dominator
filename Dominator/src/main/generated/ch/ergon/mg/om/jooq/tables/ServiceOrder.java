...
public class ServiceOrder extends TableImpl<ServiceOrderRecord> {
     ...
     */
    public final TableField<ServiceOrderRecord, OrderState> STATE = createField("state", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(ch.ergon.mg.om.jooq.enums.OrderState.class), this, "");
