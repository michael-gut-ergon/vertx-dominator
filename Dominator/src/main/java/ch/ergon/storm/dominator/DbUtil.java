...
import static ch.ergon.storm.dominator.jooq.Tables.CUSTOMER;
import static ch.ergon.storm.dominator.jooq.Tables.FACTORY;
import static ch.ergon.storm.dominator.jooq.Tables.PRODUCT;
import static ch.ergon.storm.dominator.jooq.Tables.SERVICE;
import static ch.ergon.storm.dominator.jooq.Tables.SERVICE_ORDER;
import static ch.ergon.storm.dominator.jooq.Tables.SERVICE_PARAMETER;
import static ch.ergon.storm.dominator.jooq.Tables.SERVICE_PARAMETER_BATCH;
import static ch.ergon.storm.dominator.jooq.Tables.SERVICE_PRODUCTION;
import static ch.ergon.storm.dominator.jooq.Tables.SERVICE_HISTORY;
...
import ch.ergon.storm.dominator.jooq.tables.pojos.ServiceOrder;
import ch.ergon.storm.dominator.jooq.tables.pojos.ServiceParameter;
import ch.ergon.storm.dominator.jooq.tables.pojos.ServiceParameterBatch;
import ch.ergon.storm.dominator.jooq.tables.pojos.ServiceProduction;
...
public class DbUtil {
    ...
    public List<ch.ergon.storm.dominator.jooq.tables.ServiceHistory> getServiceHistorys(Integer id) {
    	List<ch.ergon.storm.dominator.jooq.tables.ServiceHistory> histories = new ArrayList<ch.ergon.storm.dominator.jooq.tables.ServiceHistory>();
	    try {
	    	LOGGER.info("getServiceHistorys");
	    	histories = sql.select()
	    			.from(SERVICE_HISTORY)
	    			.where(Arrays.asList(SERVICE_HISTORY.SERVICE.eq(id)))
	    			.fetchInto(ch.ergon.storm.dominator.jooq.tables.ServiceHistory.class);
	    } catch (Exception e) {
